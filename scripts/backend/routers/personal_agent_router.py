...
Endpoint'ler SRP'ye uygun alt modüllere taşındı:
  ...
  api/orchestrator_api.py  — Multi-project orchestrator
"""
from __future__ import annotations

from fastapi import APIRouter

from .api import plans_api, calendar_api, projects_api, scheduler_api, pdf_api, backup_api, orchestrator_api
...
router.include_router(backup_api.router)
router.include_router(orchestrator_api.router)
